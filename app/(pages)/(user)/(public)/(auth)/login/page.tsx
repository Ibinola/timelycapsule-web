...
const Login = () => {
  ...
  return (
    <div className=" min-h-svh flex items-center justify-center h-screen bg-[#FAFAFA] w-full">
      ...
      {/* Login Form Section */}
      <div className="w-full md:w-[55%] px-6 h-screen pt-14 flex flex-col items-center md:items-start lg:pl-32">
        <div className=" flex flex-col w-full md:max-w-[424px]">
          <section className="mb-4 flex flex-col justify-start gap-20">
            ...
            <div>
              <h2 className="text-[20px] md:text-[24px] font-bold mb-1 font-kumbhSans text-black">
                Welcome back
              </h2>
